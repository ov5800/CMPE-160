...
entity ex8_tb_tri is
end ex8_tb_tri;

architecture test_bench of ex8_tb_tri is

  -- component declaration for the Unit Under Test (UUT)
  component Ex8Tri port ( 
    -- circuit inputs
    CLK :   in  std_logic;
    SL :    in  std_logic;
    SIN :   in  std_logic;
  ...
  begin
      ...
      RST <= '1';           -- at 75 ns, fill in the new RST value 
      wait;
  end process;
  ...
  begin
      SL <= '1';             -- at  0 ns
      wait for 125 ns;       
      SL <= '0';            -- at 125 ns, fill in the new SL value  
      wait;
  end process;
...
-- stimulus SIN
  ...
  begin
      SIN <= '0';            -- at  0 ns
      wait for 325 ns;       
      SIN <= '1';           -- at 325 ns, fill in the new SIN value  
      wait;
  end process;
